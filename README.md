...
In this project, you'll use generative adversarial networks to generate new images of faces and numbers.



The data comes [CelebA](http://mmlab.ie.cuhk.edu.hk/projects/CelebA.html) and [MNIST](http://mmlab.ie.cuhk.edu.hk/projects/CelebA.html).
